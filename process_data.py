...
def get_args():
    ...
    parser.add_argument('--path',type=str,default='E:/2 MASTER/Memoire/07-06-2021 (croped)/normal_croped/dataset/4000')
    parser.add_argument('--target',type=int,default=1)
    # arguments for training
    #parser.add_argument('--nrows', type = int , default = 3616)

    parser.add_argument('--out', type=str, default='E:/2 MASTER/Memoire/07-06-2021 (croped)/normal_croped/dataset/zipf csv')
...
def main():
    ...
    final_df.to_csv(os.path.join(args.out,'data_normal_target.csv'),index=False)
